...
def creat_slide2fig2(prs,tx1,fig1,fig2):
    ...
    pic = placeholder.insert_picture(fig2)
def creat_slide2fig2i(prs,tx1,fig1,fig2,i):
    graph_slide_layout = prs.slide_layouts[4]
    slide = prs.slides.add_slide(graph_slide_layout)
    title = slide.shapes.title
    title.text = tx1
    subtitle = slide.placeholders[1]
    subtitle.text = "{:%Y-%m-%d}".format(getday(i))+' 08'
    placeholder = slide.placeholders[13]
    pic = placeholder.insert_picture(fig1)
    subtitle = slide.placeholders[3]
    subtitle.text = "{:%Y-%m-%d}".format(getday(i))+' 20'
    placeholder = slide.placeholders[14]
    pic = placeholder.insert_picture(fig2)
...
def create_ppt(input, output, chart):
    ...
    creat_slide2fig2(prs,"500hPa天气形势 & 850hPa风场 ",df.name[65],df.name[66])
    #creat_slide2fig2i(prs,"500hPa天气形势 &850hPa风场 ",df.name[69],df.name[70],1)
    creat_slide2fig2i(prs,"500hPa天气形势 & 850hPa风场 ",df.name[71],df.name[72],2)
    creat_slide2fig2i(prs,"500hPa天气形势 & 850hPa风场 ",df.name[73],df.name[74],3)
    creat_slide2fig2i(prs,"500hPa天气形势 & 850hPa风场 ",df.name[75],df.name[76],4)
    creat_slide2fig2i(prs,"500hPa天气形势 & 850hPa风场 ",df.name[77],df.name[78],5)
    creat_slide2fig2i(prs,"500hPa天气形势 & 850hPa风场 ",df.name[79],df.name[80],6)
    creat_slide2fig2i(prs,"500hPa天气形势 & 850hPa风场 ",df.name[81],df.name[82],7)
    creat_slide2fig2i(prs,"500hPa天气形势 & 850hPa风场 ",df.name[83],df.name[84],8)
    #creat_slide2fig2(prs,"500hPa天气形势 &850hPa风场 ",df.name[85],df.name[86],9)
    #creat_slide2fig2(prs,"地面 天气形势",df.name[67],df.name[68])
    creat_slide2fig1(prs,"青岛10m风速逐小时变化",df.name[50])
    creat_slide2fig1(prs,"青岛10m风速风向逐小时变化",df.name[51])
    creat_slide2fig1(prs,"青岛降水逐小时变化",df.name[52])
