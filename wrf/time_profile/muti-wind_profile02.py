...
x_y = ll_to_xy(ncfile[0], '32.0', '118.80')
x=x_y[0]
y=x_y[1]
print(x)
print(y)
...
ax.title.set_text(" ")
ax.annotate("(B)", xy=(0.01, 1.01), xycoords="axes fraction")
...
Q=ax.quiver(T, H, u, v, units='width',scale=800)#(scale=1000,scale_units='width')
qk = plt.quiverkey(Q, 0.763, 0.9, 30, r'$30 \frac{m}{s}$', labelpos='E',
                   coordinates='figure')
#ax.xaxis_date()
...
#plt.savefig("mwind_profile-02-10.png",dpi=600,bbox_inches='tight')
plt.savefig("mwind_profile-02_new.png",dpi=600,bbox_inches='tight')
#plt.show()
