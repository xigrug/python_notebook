...
ncfile = Dataset("../domain04/use_d04/wrfout_d04_2017-06-10_01:00:00")
...
start_point = CoordPair(lat=31.4, lon=118)
end_point = CoordPair(lat=32, lon=118.9)
...
plt.savefig("cross09bjt.png",dpi=200)
