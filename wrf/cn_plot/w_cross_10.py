...
ncfile = Dataset("../domain04/use_d04/wrfout_d04_2017-06-10_02:00:00")
...
start_point = CoordPair(lat=31.6, lon=117.96)
end_point = CoordPair(lat=31.86, lon=119.5)
...
plt.savefig("cross10bjt.png",dpi=200)
