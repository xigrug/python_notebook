...
ncfile = Dataset("../domain04/use_d04/wrfout_d04_2017-06-10_06:00:00")
...
start_point = CoordPair(lat=31.72, lon=118)
end_point = CoordPair(lat=31.67, lon=119.6)
...
plt.savefig("cross14bjt.png",dpi=200)
