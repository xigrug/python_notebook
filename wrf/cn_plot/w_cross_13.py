...
ncfile = Dataset("../domain04/use_d04/wrfout_d04_2017-06-10_05:00:00")
...
start_point = CoordPair(lat=31.6, lon=118.8)
end_point = CoordPair(lat=31.65, lon=119.6)
...
plt.savefig("cross13bjt.png",dpi=200)
