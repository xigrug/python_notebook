...
ncfile = [Dataset("../wrfout_d04_2017-06-09_23:00:00"),
          Dataset("../wrfout_d04_2017-06-10_00:00:00")]
      #    Dataset("../wrfout_d04_2017-06-10_01:00:00"),
      #    Dataset("../wrfout_d04_2017-06-10_02:00:00"),
      #    Dataset("../wrfout_d04_2017-06-10_03:00:00"),
      #    Dataset("../wrfout_d04_2017-06-10_04:00:00"),
      #    Dataset("../wrfout_d04_2017-06-10_05:00:00"),
      #    Dataset("../wrfout_d04_2017-06-10_06:00:00"),
      #    Dataset("../wrfout_d04_2017-06-10_07:00:00"),
      #    Dataset("../wrfout_d04_2017-06-10_08:00:00")]
x_y = ll_to_xy(ncfile[0], '31.36', '118.0')
x=x_y[0]
y=x_y[1]
#wrftime=extract_times(ncfile,timeidx=ALL_TIMES,do_xtime=True)
wrftime=extract_times(ncfile,timeidx=ALL_TIMES)
print(wrftime)
###squeeze=False nofiledim
p = getvar(ncfile, "pressure",timeidx=ALL_TIMES,method="cat")[:,:,x,y]
#p = getvar(ncfile, "pressure")[:,:,x,y]
#pblh = getvar(ncfile, "PBLH",timeidx=ALL_TIMES,squeeze=False)[:,x,y]
times = getvar(ncfile, "XTIME",timeidx=ALL_TIMES,method="cat")
#times = getvar(ncfile, "XTIME")
print(times)
heights = getvar(ncfile, "z", units="km",timeidx=ALL_TIMES,method="cat")[0,:,x,y]
u = getvar(ncfile, "ua", units="kt",timeidx=ALL_TIMES,method="cat")[:,:,x,y]
v = getvar(ncfile, "va", units="kt",timeidx=ALL_TIMES,method="cat")[:,:,x,y]
...
rh = getvar(ncfile, "rh",timeidx=ALL_TIMES,method="cat")[:,:,x,y]
...
wrftime_f = (np.asarray(wrftime, dtype=np.float32))####TypeError
H, T = np.meshgrid(heights,wrftime_f)
...
#ax.set_xlim(wrftime_f[0]-np.timedelta64(30, 'm'), wrftime_f[-1]-np.timedelta64(30, 'm'))
...
plt.savefig("time_profile.png",dpi=600,bbox_inches='tight')
#plt.savefig("time_profile.png")
#plt.show()
