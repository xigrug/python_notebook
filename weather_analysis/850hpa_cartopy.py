...
hr=str(12)
print(hr)
dataFile = '../ERA-Int_5pl_201504'+day+'.nc'
...
gl.ylabel_style = {'size': 15}#, 'weight': 'bold'}#'color': 'gray'}
...
ax.set_title('850-hPa Heights (m), Temperature ($^{o}C$)\n 2015-04-'+day+' '+hr+':00:00UTC', fontsize=16)
plt.plot(83.63,39.04,'bo', transform=ccrs.PlateCarree())
plt.text(84.03,39.34, 'TZ',color='b',
...
#plt.savefig(dataFile[3:23]+"_850hpa.png")
plt.savefig(day+hr+"_850hpa.png",bbox_inches='tight')
