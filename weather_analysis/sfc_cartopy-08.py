...
#Open the dataset and print out metadeta
    ...
    ds.sel(time=('2015-04-'+day+'T00:00:00'))
    psfc=ds.sp.sel(time=('2015-04-'+day+'T00:00:00'))/100
...
#avor_levels = np.linspace(15e-5,60e-5, 10)
    ax.set_title('Surface Pressure(hPa), 2015-04-'+day+' 00:00:00UTC', fontsize=20)
...
#vrel = ds['v'].sel(level=500).isel(time=0).values*1.944
    urel=ds.u10.sel(time=('2015-04-'+day+'T00:00:00')).values*1.944
    vrel=ds.v10.sel(time=('2015-04-'+day+'T00:00:00')).values*1.944

#Plot the barbs
    ax.barbs(lon, lat, urel, vrel, regrid_shape=12, zorder=20, transform=ccrs.PlateCarree())

#plt.savefig(dataFile[3:23]+"_500hpaWind.png")
    plt.savefig(day+"00_sfc-smoothHL.png",bbox_inches='tight')
