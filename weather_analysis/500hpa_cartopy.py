...
hgt=ds.z.sel(time=('2015-04-'+day+'T12:00:00'), level=500)
...
ax.set_title('500-hPa Heights(m), Barbs(kt), 2015-04-'+day+' 12:00:00UTC', fontsize=20)
...
plt.savefig(day+"12_500hpaWind.png",bbox_inches='tight')
