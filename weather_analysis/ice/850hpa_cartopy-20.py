...
#Open the dataset and print out metadeta
    ...
    ds.sel(time=('2017-05-'+day+'T12:00:00'), level=850)
    hgt=ds.z.sel(time=('2017-05-'+day+'T12:00:00'), level=850)/9.8/10
    tem=ds.t.sel(time=('2017-05-'+day+'T12:00:00'), level=850)-273.15
...
#vrel = ds['v'].sel(level=850).isel(time=0).values*1.944
    urel=ds.u.sel(time=('2017-05-'+day+'T12:00:00'), level=850).values*1.944
    vrel=ds.v.sel(time=('2017-05-'+day+'T12:00:00'), level=850).values*1.944
