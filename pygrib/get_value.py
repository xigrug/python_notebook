...
def potential_temperature(T,p):
    ...
    # Read data
for f in glob.glob("AUTO_5MINS_NPP_MicroPhys_2015*.txt"):
    print(f)
    ...
    month=time[4:6]
    day=time[6:8]
    grib='/data/c02n03/archive/ds083.3/2015/gdas1.fnl0p25.'+year+month+day+'06.f00.grib2'
    gr = pygrib.open(grib)
    ...
    df.to_csv(f[:-4]+".csv",index=True,sep=',')
    df.head(10)
